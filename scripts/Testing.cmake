...
function(activate_code_coverage)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    ...
    if(NOT Python3_FOUND
       ...
       OR NOT llvm_cov)
      string(APPEND message "Python3, llvm_profdata and llvm_cov are required for code coverage testing.")
      if(NOT Python3_FOUND)
  ...
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    if(NOT Python3_FOUND OR NOT gcovr)
      string(APPEND message "Python3 and gcovr are required for code coverage testing.")
      if(NOT Python3_FOUND)
        string(APPEND message "\n  -- Python3 was not found.")
      endif()
      if(NOT gcovr)
...
function(enable_lit_tests)
  ...
  if(NOT Python3_FOUND
     OR NOT lit
     OR NOT FileCheck)
    string(APPEND message "Python3, lit and FileCheck are required for LIT testing.")
    if(NOT Python3_FOUND)
      string(APPEND message "\n  -- Python3 was not found.")
    endif()
    if(NOT lit)
    ...
    if(NOT FileCheck)
      string(APPEND message "\n  -- FileCheck was not found.")
    endif()
    string(APPEND message "\nLIT tests will not be enabled.")
    message(WARNING ${message})
    return()
  endif()
