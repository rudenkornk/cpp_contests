...
BOOST_AUTO_TEST_CASE(library_function_tests) {
  ...
  BOOST_TEST(compute_hits({1, 2, 3, 1, 2, 4, 5, 1, 7, 3, 2, 6, 1, 2}, 4) ==
             std::size_t{4});
  BOOST_TEST(compute_hits({1, 2, 3, 4, 1, 2, 5, 1, 2, 4, 3, 4, 2,
                           1, 4, 4, 2, 1, 5, 1, 2, 5, 2, 5, 1},
                          4) == std::size_t{12});
  BOOST_TEST(compute_hits({1, 2, 3, 4, 1, 2, 5, 1, 2, 4, 3, 4}, 4) ==
             std::size_t{0});
