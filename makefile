...
.PHONY: config
config:
	cmake -DPARALLEL_TESTING=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DLIT=ON -DVALGRIND=OFF -DCODE_COVERAGE=OFF -DCMAKE_BUILD_TYPE=$(BUILD_TYPE) -B $(BUILD_DIR) $(CONFIG_OPTIONS)
